...
export default function Hero(){
    ...
    return(
        <div id="hero" className="relative overflow-hidden py-5 pb-64 lg:pb-32 sm:pb-48 min-h-[680px]">
            ...
            <div className="relative z-10 px-3 pt-56 xl:px-32 sm:px-5 lg:pt-44 sm:pt-60">
                <h3
                    className="bg-[#0077C0] text-black font-pixelmono lg:text-2xl text-base sm:text-lg uppercase -ml-0.5 inline-block px-3 rounded mb-2"
                >
                ...
                <TextType 
                    ...
                    className="text-6xl lg:text-9xl sm:text-8xl font-pixelsans mb-2"
                />
                <p
